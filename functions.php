...
function hestiachild_features_section_3_customize_register ( $wp_customize ) {
	
		if ( class_exists( 'Hestia_Hiding_Section' ) ) {
			$wp_customize->add_section(
				new Hestia_Hiding_Section(
					$wp_customize, 'hestiachild_features_section_3_options', array(
						'title'          => __( 'Features Section 3', 'hestia-child' ),
						'panel'          => 'hestia_frontpage_sections',
						'description'	=> __('Second set of features', 'hestia-child'),
						'hiding_control' => 'hestiachild_features_section_3_hide',
					)
				)
			);
		} else {
			$wp_customize->add_section(
				'hestiachild_features_section_3_options',
				array(
					'title'			=> __( 'Features Section 3', 'hestia-child' ),
					'capability'	=> 'edit_theme_options',
					'description'	=> __('Second set of features', 'hestia-child'),
		...
		$wp_customize->add_setting(
			'hestiachild_features_section_3_hide', array(
				'sanitize_callback' => 'hestia_sanitize_checkbox',
				'default'           => false,
				'transport'         => $selective_refresh,
			)
		...
		$wp_customize->add_setting( 'hestiachild_features_section_3a_icon',
			array(
				'type'		=> 'theme_mod',
				'default'	=> 'fa-wechat'	
			)
		...
		$wp_customize->add_setting( 'hestiachild_features_section_3a_colour',
			array(
				'type'		=> 'theme_mod',
				'default'	=> '#ffffff'	
			)
		...
		$wp_customize->add_setting( 'hestiachild_features_section_3a_title',
			array(
				'type'		=> 'theme_mod',
				'default'	=> 'title a'	
			)
		...
		$wp_customize->add_setting( 'hestiachild_features_section_3a_text',
			array(
				'type'		=> 'theme_mod',
				'default'	=> 'text a'	
			)
		...
		$wp_customize->add_setting( 'hestiachild_features_section_3a_link',
			array(
				'type'		=> 'theme_mod',
				'default'	=> '#'	
			)
		...
		$wp_customize->add_setting( 'hestiachild_features_section_3b_icon',
		array(
			'type'		=> 'theme_mod',
			'default'	=> 'fa-wechat'	
		)
		...
		$wp_customize->add_setting( 'hestiachild_features_section_3b_colour',
			array(
				'type'		=> 'theme_mod',
				'default'	=> '#ffffff'	
			)
		...
		$wp_customize->add_setting( 'hestiachild_features_section_3b_title',
			array(
				'type'		=> 'theme_mod',
				'default'	=> 'title b'	
			)
		...
		$wp_customize->add_setting( 'hestiachild_features_section_3b_text',
			array(
				'type'		=> 'theme_mod',
				'default'	=> 'TEXT b'	
			)
		...
		$wp_customize->add_setting( 'hestiachild_features_section_3b_link',
			array(
				'type'		=> 'theme_mod',
				'default'	=> '#'	
			)
		...
		$wp_customize->add_setting( 'hestiachild_features_section_3_background_colour',
			array(
				'type'		=> 'theme_mod',
				'default'	=> '#ffffff'	
			)
		...
		$wp_customize->add_control(
			'hestiachild_features_section_3_background_colour',
			array(
				'label'		=> __('section background colour','hestia-child'),
				'section'	=> 'hestiachild_features_section_3_options',
				'type'		=> 'text'
			)
		);
		...
		$wp_customize->add_control(
			'hestiachild_features_section_3a_icon',
			array(
				'label'		=> __('icon a','hestia-child'),
				'section'	=> 'hestiachild_features_section_3_options',
				'type'		=> 'text'
		...
		$wp_customize->add_control(
			'hestiachild_features_section_3a_colour',
			array(
				'label'		=> __('colour a','hestia-child'),
				'section'	=> 'hestiachild_features_section_3_options',
				'type'		=> 'text'
		...
		$wp_customize->add_control(
			'hestiachild_features_section_3a_title',
			array(
				'label'		=> __('title a','hestia-child'),
				'section'	=> 'hestiachild_features_section_3_options',
				'type'		=> 'text'
		...
		$wp_customize->add_control(
			'hestiachild_features_section_3a_text',
			array(
				'label'		=> __('text a','hestia-child'),
				'section'	=> 'hestiachild_features_section_3_options',
				'type'		=> 'text'
		...
		$wp_customize->add_control(
			'hestiachild_features_section_3a_link',
			array(
				'label'		=> __('link a','hestia-child'),
				'section'	=> 'hestiachild_features_section_3_options',
				'type'		=> 'text'
		...
		$wp_customize->add_control(
			'hestiachild_features_section_3b_icon',
			array(
				'label'		=> __('icon b','hestia-child'),
				'section'	=> 'hestiachild_features_section_3_options',
				'type'		=> 'text'
		...
		$wp_customize->add_control(
			'hestiachild_features_section_3b_colour',
			array(
				'label'		=> __('colour b','hestia-child'),
				'section'	=> 'hestiachild_features_section_3_options',
				'type'		=> 'text'
		...
		$wp_customize->add_control(
			'hestiachild_features_section_3b_title',
			array(
				'label'		=> __('title b','hestia-child'),
				'section'	=> 'hestiachild_features_section_3_options',
				'type'		=> 'text'
		...
		$wp_customize->add_control(
			'hestiachild_features_section_3b_text',
			array(
				'label'		=> __('text b','hestia-child'),
				'section'	=> 'hestiachild_features_section_3_options',
				'type'		=> 'text'
		...
		$wp_customize->add_control(
			'hestiachild_features_section_3b_link',
			array(
				'label'		=> __('link b','hestia-child'),
				'section'	=> 'hestiachild_features_section_3_options',
				'type'		=> 'text'
	...
	add_action( 'customize_register', 'hestiachild_features_section_3_customize_register' );
	
	
	function features_section_3(){
	
		if(!get_theme_mod('hestiachild_features_section_3_hide')){
			$backgroundcolour = get_theme_mod('hestiachild_features_section_3_background_colour'); 
			$coloura = get_theme_mod('hestiachild_features_section_3a_colour'); 
			$linka = get_theme_mod('hestiachild_features_section_3a_link');
			$icona = get_theme_mod('hestiachild_features_section_3a_icon');
			$texta = get_theme_mod('hestiachild_features_section_3a_text');	
			$titlea = get_theme_mod('hestiachild_features_section_3a_title');
			$colourb = get_theme_mod('hestiachild_features_section_3b_colour'); 
			$linkb = get_theme_mod('hestiachild_features_section_3b_link');
			$iconb = get_theme_mod('hestiachild_features_section_3b_icon');
			$textb = get_theme_mod('hestiachild_features_section_3b_text');	
			$titleb = get_theme_mod('hestiachild_features_section_3b_title');
